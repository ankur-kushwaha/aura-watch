  ...
  try {
    ...
    const newStream = await prisma.cameraStream.create({
      data: {
        ...
        edgeYoloEnabled: edgeYoloEnabled !== undefined ? Boolean(edgeYoloEnabled) : STREAM_CONFIG_DEFAULTS.edgeYoloEnabled,
  ...
  try {
    ...
    const updatedStream = await prisma.cameraStream.update({
      ...
      data: {
        ...
        edgeYoloEnabled: edgeYoloEnabled !== undefined ? Boolean(edgeYoloEnabled) : existing.edgeYoloEnabled,
